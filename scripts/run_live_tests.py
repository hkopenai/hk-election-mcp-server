"""
Script to run live tests for the HK OpenAI Election MCP Server.

This script sets up the environment to run live tests using pytest, allowing
for the execution of specific tests or all live tests in the test suite.
"""
